...
\begin{itemize}
	\item[1º] A escolha do coordenador é baseada em critérios que garantem a monotonicidade temporal.
	\item[2º] O coordenador envia sua estampa de tempo, em períodos fixos, para que todos os dispositivos mantenham-se sincronizados.
\end{itemize}
...
\bibitem[Coulouris \textit{et. al.} 2012]{coulouris2012} G. Coulouris, J. Dollimore, T. Kindberg e G. Blair (2012). Distributed {S}ystems:
