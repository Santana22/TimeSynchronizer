...
Para realizar a comunicação entre os dispositivos, com o auxílio do Java, foi definido um grupo de \textit{multicast}. Este compreende os interessados em enviar e receber mensagens. Além disto, \textit{Threads} e o protocolo de transporte UDP foram utilizados também. No aspecto comunicativo, é importante que os dispositivos possam se comunicar de maneira eficiente e padronizada. Desse modo, é importante definir um protocolo de comunicação. As informações estão na Tabela 1.
...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline 
		\textbf{Operação} & \textbf{Cod. da Operação} & \textbf{Qtd. de Parâmetros}  \\ 
		\hline 
